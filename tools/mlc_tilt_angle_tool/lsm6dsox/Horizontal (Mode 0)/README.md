...
- **first angle** *(in this tutorial set to -6 deg)*. It must be an integer in the range of -90 to +90 [deg].
- **last angle** *(in this tutorial set to 6 deg)*. It must be an integer in the range of -90 to +90 [deg]. This angle must be greater than the *first angle*
